...
INSERT INTO courts (userId, courtName, location, isIndoor, image) VALUES
    (1, 'Padel Zone', '123 Elm Street, Austin, TX', false,'a'),
    (1, 'Ace Arena', '456 Oak Avenue, Miami, FL', false,'a'),
    (1, 'The Padel Hub', '789 Maple Road, Denver, CO', true,'a'),
    (1, 'Smash Court', '101 Pine Lane, Seattle, WA', false,'a'),
    (1, 'Net Masters', '202 Cedar Street, Nashville, TN', true,'a'),
    (2, 'PowerPadel', '303 Birch Drive, Austin, TX', false,'a'),
    (2, 'Rally Point', '404 Spruce Boulevard, Portland, OR', true,'a'),
