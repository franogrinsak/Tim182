...
export default function EditCourt() {
  ...
  const saveImage = court.image;
  const [previewImage, setPreviewImage] = React.useState(court.image);
  const [imageUrl, setImageUrl] = React.useState(court?.imageSrc);
  ...
  return (
    <div className="flex flex-col items-center">
      <ReturnButton
        link={"/app/courts/" + ownerId + "/" + courtId}
            ...
            <div className="flex flex-wrap flex-col -mx-3 mb-6 register-layout">
              <div className="mb-4">
                ...
                <input
                  ...
                  id="courtName"
                  name="courtName"
                  defaultValue={court ? court.courtName : ""}
                  type="text"
              ...
              <div>
                ...
                <input
                  ...
                  id="location"
                  name="location"
                  defaultValue={court ? court.location : ""}
                  type="text"
            ...
            <div className="-mx-3 mb-6">
              ...
              <div className="flex flex-column items-start">
                <div className="inline-block relative w-28">
                  <select
                    name="isIndoor"
                    defaultValue={court ? court.isIndoor : "true"}
